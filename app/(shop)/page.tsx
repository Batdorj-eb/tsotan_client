    ...
    <>
        ...
        <section className="py-20 lg:py-24">
          <div className="mx-auto max-w-7xl px-5 lg:px-8">
            <div className="flex items-end justify-between gap-6">
              <div>
                <p className="text-[11px] uppercase tracking-[0.24em] text-gold">Коллекц</p>
                <h2 className="mt-2 font-display text-4xl">Шинэ бараа</h2>
              </div>
              <Link
                href="/shop-new"
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-24 text-center text-cream lg:px-8">
          ...
          <h2 className="mt-3 font-display text-4xl sm:text-5xl">Дэлгүүрээр зочлох</h2>
          <Link
            href="/shop"
